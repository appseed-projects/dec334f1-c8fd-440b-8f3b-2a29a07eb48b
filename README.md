...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-10-14 16:40`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/dec334f1-c8fd-440b-8f3b-2a29a07eb48b.git
$ cd dec334f1-c8fd-440b-8f3b-2a29a07eb48b
```
